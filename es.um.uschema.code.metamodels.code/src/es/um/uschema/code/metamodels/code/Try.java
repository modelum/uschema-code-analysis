 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.Try#getCatchs <em>Catchs</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.Try#getCodeBlock <em>Code Block</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.Try#getFinally <em>Finally</em>}</li>
 * </ul>
 *
 * @see es.um.uschema.code.metamodels.code.CodePackage#getTry()
 * @model
 * @generated
 */
public interface Try extends Statement
{
	 ...
	 * The list contents are of type {@link es.um.uschema.code.metamodels.code.Catch}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Catchs</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Catchs</em>' containment reference list.
	 * @see es.um.uschema.code.metamodels.code.CodePackage#getTry_Catchs()
	 ...
	 * @see es.um.uschema.code.metamodels.code.CodePackage#getTry_CodeBlock()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link es.um.uschema.code.metamodels.code.Try#getCodeBlock <em>Code Block</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.um.uschema.code.metamodels.code.CodePackage#getTry_Finally()
	 * @model containment="true"
	 * @generated
	 */
	Finally getFinally();
	...
	/**
	 * Sets the value of the '{@link es.um.uschema.code.metamodels.code.Try#getFinally <em>Finally</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
