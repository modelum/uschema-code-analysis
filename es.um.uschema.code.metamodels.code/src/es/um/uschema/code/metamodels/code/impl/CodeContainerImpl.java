 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CodeContainerImpl#getType <em>Type</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CodeContainerImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CodeContainerImpl#getCodeBlock <em>Code Block</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CodeContainerImpl#getDataContainer <em>Data Container</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CodeContainerImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
