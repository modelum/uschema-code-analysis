 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CodeBlockImpl#getStatements <em>Statements</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CodeBlockImpl#getCodeBlockType <em>Code Block Type</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CodeBlockImpl#getVariables <em>Variables</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CodeBlockImpl#getReturnType <em>Return Type</em>}</li>
 * </ul>
 *
 * @generated
 */
