...
import es.um.uschema.code.metamodels.code.ExpressionType;
...
import es.um.uschema.code.metamodels.code.OperationType;
...
public class CodePackageImpl extends EPackageImpl implements CodePackage
{
	 ...
	 * @see es.um.uschema.code.metamodels.code.CodePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents()
	{
		...
		initEClass(containerEClass, es.um.uschema.code.metamodels.code.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getContainer_Type(), this.getContainerType(), "type", null, 0, 1, es.um.uschema.code.metamodels.code.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_CodeContainer(), this.getCodeContainer(), null, "codeContainer", null, 0, -1, es.um.uschema.code.metamodels.code.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_SubContainer(), this.getContainer(), null, "subContainer", null, 0, -1, es.um.uschema.code.metamodels.code.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getContainer_Name(), ecorePackage.getEString(), "name", null, 0, 1, es.um.uschema.code.metamodels.code.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(exceptionEClass, es.um.uschema.code.metamodels.code.Exception.class, "Exception", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getException_ExceptionName(), ecorePackage.getEString(), "exceptionName", null, 0, 1, es.um.uschema.code.metamodels.code.Exception.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
