 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.ArgumentImpl#getDataProducer <em>Data Producer</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.ArgumentImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.ArgumentImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
