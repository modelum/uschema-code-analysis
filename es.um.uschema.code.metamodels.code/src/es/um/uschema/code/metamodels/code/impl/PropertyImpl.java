 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.PropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.PropertyImpl#getType <em>Type</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.PropertyImpl#getInitialization <em>Initialization</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.PropertyImpl#getDataContainer <em>Data Container</em>}</li>
 * </ul>
 *
 * @generated
 */
