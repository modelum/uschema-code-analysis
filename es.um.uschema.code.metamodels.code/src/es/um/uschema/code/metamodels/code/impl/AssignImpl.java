 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.AssignImpl#getOutputs <em>Outputs</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.AssignImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.AssignImpl#getInputs <em>Inputs</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.AssignImpl#getType <em>Type</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.AssignImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
