 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.NewClassImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.NewClassImpl#getCodeContainer <em>Code Container</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.NewClassImpl#getCallableBlock <em>Callable Block</em>}</li>
 * </ul>
 *
 * @generated
 */
