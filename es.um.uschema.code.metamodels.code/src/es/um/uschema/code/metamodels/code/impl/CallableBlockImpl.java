 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CallableBlockImpl#getStart <em>Start</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CallableBlockImpl#getEnd <em>End</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CallableBlockImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CallableBlockImpl#getType <em>Type</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CallableBlockImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.CallableBlockImpl#getFunctionName <em>Function Name</em>}</li>
 * </ul>
 *
 * @generated
 */
