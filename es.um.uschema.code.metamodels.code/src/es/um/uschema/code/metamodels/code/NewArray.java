 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.NewArray#getDataProducer <em>Data Producer</em>}</li>
 * </ul>
 *
 * @see es.um.uschema.code.metamodels.code.CodePackage#getNewArray()
 * @model
 * @generated
 */
public interface NewArray extends DataProducer
{
	 ...
	 * @see es.um.uschema.code.metamodels.code.CodePackage#getNewArray_DataProducer()
