 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.DataContainerImpl#getStart <em>Start</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.DataContainerImpl#getEnd <em>End</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.DataContainerImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.DataContainerImpl#getType <em>Type</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.DataContainerImpl#getInitialization <em>Initialization</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.DataContainerImpl#getDataContainer <em>Data Container</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.DataContainerImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.DataContainerImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
