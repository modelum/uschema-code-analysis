 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.TryImpl#getCatchs <em>Catchs</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.TryImpl#getCodeBlock <em>Code Block</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.TryImpl#getFinally <em>Finally</em>}</li>
 * </ul>
 *
 * @generated
 */
