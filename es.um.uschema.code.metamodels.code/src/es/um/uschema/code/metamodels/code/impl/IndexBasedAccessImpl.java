 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.IndexBasedAccessImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.IndexBasedAccessImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.IndexBasedAccessImpl#getDataProducer <em>Data Producer</em>}</li>
 * </ul>
 *
 * @generated
 */
