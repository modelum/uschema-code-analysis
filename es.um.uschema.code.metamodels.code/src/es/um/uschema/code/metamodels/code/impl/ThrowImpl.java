 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.ThrowImpl#getException <em>Exception</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.code.impl.ThrowImpl#getDataProducer <em>Data Producer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThrowImpl extends StatementImpl implements Throw
{
	 ...
	 * @ordered
	 */
	protected es.um.uschema.code.metamodels.code.Exception exception;
	 ...
	 */
	@Override
	public es.um.uschema.code.metamodels.code.Exception getException()
	{
		if (exception != null && exception.eIsProxy()) {
			InternalEObject oldException = (InternalEObject)exception;
			exception = (es.um.uschema.code.metamodels.code.Exception)eResolveProxy(oldException);
	 ...
	 * @generated
	 */
	public es.um.uschema.code.metamodels.code.Exception basicGetException()
	{
		return exception;
	}
	 ...
	 */
	@Override
	public void setException(es.um.uschema.code.metamodels.code.Exception newException)
	{
		es.um.uschema.code.metamodels.code.Exception oldException = exception;
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID) {
			case CodePackage.THROW__EXCEPTION:
				setException((es.um.uschema.code.metamodels.code.Exception)newValue);
				return;
			case CodePackage.THROW__DATA_PRODUCER:
	...
	public void eUnset(int featureID)
	{
		switch (featureID) {
			case CodePackage.THROW__EXCEPTION:
				setException((es.um.uschema.code.metamodels.code.Exception)null);
				return;
			case CodePackage.THROW__DATA_PRODUCER:
