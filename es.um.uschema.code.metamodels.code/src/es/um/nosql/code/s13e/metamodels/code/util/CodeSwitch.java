...
public class CodeSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID) {
			...
			case CodePackage.EXCEPTION: {
				es.um.nosql.code.s13e.metamodels.code.Exception exception = (es.um.nosql.code.s13e.metamodels.code.Exception)theEObject;
	 ...
	 * @generated
	 */
	public T caseException(es.um.nosql.code.s13e.metamodels.code.Exception object)
	{
		return null;
	}
