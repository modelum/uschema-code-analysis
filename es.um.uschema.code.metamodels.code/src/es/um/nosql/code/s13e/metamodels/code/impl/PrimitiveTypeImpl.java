 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.PrimitiveTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveTypeImpl extends TypeImpl implements PrimitiveType
{
	...
	public void setType(String newType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodePackage.PRIMITIVE_TYPE__TYPE, oldType, type));
	}
	...
	{
		switch (featureID) {
			case CodePackage.PRIMITIVE_TYPE__TYPE:
				return getType();
		}
