 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.ContainerImpl#getType <em>Type</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.ContainerImpl#getCodeContainer <em>Code Container</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.ContainerImpl#getSubContainer <em>Sub Container</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.ContainerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainerImpl extends MinimalEObjectImpl.Container implements es.um.nosql.code.s13e.metamodels.code.Container
{
	/**
	 ...
	 * @ordered
	 */
	protected EList<es.um.nosql.code.s13e.metamodels.code.Container> subContainer;
	 ...
	 */
	@Override
	public EList<es.um.nosql.code.s13e.metamodels.code.Container> getSubContainer()
	{
		if (subContainer == null) {
			subContainer = new EObjectContainmentEList<es.um.nosql.code.s13e.metamodels.code.Container>(es.um.nosql.code.s13e.metamodels.code.Container.class, this, CodePackage.CONTAINER__SUB_CONTAINER);
		}
		return subContainer;
	}
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID) {
			...
			case CodePackage.CONTAINER__SUB_CONTAINER:
				...
				getSubContainer().addAll((Collection<? extends es.um.nosql.code.s13e.metamodels.code.Container>)newValue);
				return;
			case CodePackage.CONTAINER__NAME:
