 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.OperationImpl#getType <em>Type</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.OperationImpl#getDataProducers <em>Data Producers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationImpl extends StatementImpl implements Operation
{
	...
	public void setType(String newType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodePackage.OPERATION__TYPE, oldType, type));
	}
	...
	public EList<DataProducer> getDataProducers()
	{
		if (dataProducers == null) {
			dataProducers = new EObjectContainmentEList<DataProducer>(DataProducer.class, this, CodePackage.OPERATION__DATA_PRODUCERS);
		}
	...
	{
		switch (featureID) {
			case CodePackage.OPERATION__DATA_PRODUCERS:
	...
	{
		switch (featureID) {
			case CodePackage.OPERATION__TYPE:
				return getType();
			case CodePackage.OPERATION__DATA_PRODUCERS:
