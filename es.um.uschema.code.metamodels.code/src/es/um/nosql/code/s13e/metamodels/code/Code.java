 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.Code#getLanguage <em>Language</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.Code#getContainer <em>Container</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.Code#getTypes <em>Types</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.Code#getException <em>Exception</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.Code#getGlobalVariable <em>Global Variable</em>}</li>
 * </ul>
 *
 * @see es.um.nosql.code.s13e.metamodels.code.CodePackage#getCode()
 * @model
 * @generated
 */
public interface Code extends EObject
{
	 ...
	 * @see es.um.nosql.code.s13e.metamodels.code.CodePackage#getCode_Language()
	 * @model
	 * @generated
	 */
	String getLanguage();
	...
	/**
	 * Sets the value of the '{@link es.um.nosql.code.s13e.metamodels.code.Code#getLanguage <em>Language</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.um.nosql.code.s13e.metamodels.code.CodePackage#getCode_Container()
	 ...
	 * The list contents are of type {@link es.um.nosql.code.s13e.metamodels.code.Type}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see es.um.nosql.code.s13e.metamodels.code.CodePackage#getCode_Types()
	 * @model containment="true"
	 * @generated
	 */
	EList<Type> getTypes();
	 ...
	 * @see es.um.nosql.code.s13e.metamodels.code.CodePackage#getCode_Exception()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see es.um.nosql.code.s13e.metamodels.code.CodePackage#getCode_GlobalVariable()
	 * @model containment="true"
	 * @generated
	 */
