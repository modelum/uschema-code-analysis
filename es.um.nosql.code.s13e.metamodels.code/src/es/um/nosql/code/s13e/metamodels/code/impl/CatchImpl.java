 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.CatchImpl#getException <em>Exception</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.CatchImpl#getCodeBlock <em>Code Block</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.CatchImpl#getDataProducer <em>Data Producer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CatchImpl extends StatementImpl implements Catch {
	...
	public EList<es.um.nosql.code.s13e.metamodels.code.Exception> getException() {
		if (exception == null) {
			exception = new EObjectResolvingEList<es.um.nosql.code.s13e.metamodels.code.Exception>(es.um.nosql.code.s13e.metamodels.code.Exception.class, this, CodePackage.CATCH__EXCEPTION);
		}
		return exception;
	}
