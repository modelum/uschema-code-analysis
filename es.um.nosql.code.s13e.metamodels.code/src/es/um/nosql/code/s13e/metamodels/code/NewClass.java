 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.NewClass#getArguments <em>Arguments</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.NewClass#getCodeContainer <em>Code Container</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.NewClass#getCallableBlock <em>Callable Block</em>}</li>
 * </ul>
 *
 * @see es.um.nosql.code.s13e.metamodels.code.CodePackage#getNewClass()
 * @model
 * @generated
 */
public interface NewClass extends DataProducer {
	 ...
	 * @see es.um.nosql.code.s13e.metamodels.code.CodePackage#getNewClass_Arguments()
	 ...
	 * @see es.um.nosql.code.s13e.metamodels.code.CodePackage#getNewClass_CodeContainer()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link es.um.nosql.code.s13e.metamodels.code.NewClass#getCodeContainer <em>Code Container</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.um.nosql.code.s13e.metamodels.code.CodePackage#getNewClass_CallableBlock()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link es.um.nosql.code.s13e.metamodels.code.NewClass#getCallableBlock <em>Callable Block</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
