 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.SelectionImpl#getType <em>Type</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.SelectionImpl#getCase <em>Case</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelectionImpl extends StatementImpl implements Selection {
	 ...
	 * @ordered
	 */
	protected static final SelectionType TYPE_EDEFAULT = SelectionType.IF;
	...
	protected EClass eStaticClass() {
		return CodePackage.Literals.SELECTION;
	}
	...
	public void setType(SelectionType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodePackage.SELECTION__TYPE, oldType, type));
	}
	...
	public EList<Case> getCase() {
		if (case_ == null) {
			case_ = new EObjectContainmentEList<Case>(Case.class, this, CodePackage.SELECTION__CASE);
		}
		return case_;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CodePackage.SELECTION__CASE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodePackage.SELECTION__TYPE:
				return getType();
			case CodePackage.SELECTION__CASE:
				return getCase();
		}
