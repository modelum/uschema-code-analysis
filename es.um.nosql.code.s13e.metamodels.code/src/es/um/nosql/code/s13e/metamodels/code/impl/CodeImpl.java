 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.CodeImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.CodeImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.CodeImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.CodeImpl#getException <em>Exception</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.CodeImpl#getGlobalVariable <em>Global Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CodeImpl extends MinimalEObjectImpl.Container implements Code {
	 ...
	 * @ordered
	 */
	protected EList<es.um.nosql.code.s13e.metamodels.code.Container> container;
	 ...
	 * @ordered
	 */
	protected EList<es.um.nosql.code.s13e.metamodels.code.Exception> exception;
	 ...
	 */
	@Override
	public EList<es.um.nosql.code.s13e.metamodels.code.Container> getContainer() {
		if (container == null) {
			container = new EObjectContainmentEList<es.um.nosql.code.s13e.metamodels.code.Container>(es.um.nosql.code.s13e.metamodels.code.Container.class, this, CodePackage.CODE__CONTAINER);
		}
		return container;
	}
	 ...
	 */
	@Override
	public EList<es.um.nosql.code.s13e.metamodels.code.Exception> getException() {
		if (exception == null) {
			exception = new EObjectContainmentEList<es.um.nosql.code.s13e.metamodels.code.Exception>(es.um.nosql.code.s13e.metamodels.code.Exception.class, this, CodePackage.CODE__EXCEPTION);
		}
		return exception;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CodePackage.CODE__CONTAINER:
				getContainer().clear();
				getContainer().addAll((Collection<? extends es.um.nosql.code.s13e.metamodels.code.Container>)newValue);
				return;
			case CodePackage.CODE__TYPES:
				getTypes().clear();
			...
			case CodePackage.CODE__EXCEPTION:
				getException().clear();
				getException().addAll((Collection<? extends es.um.nosql.code.s13e.metamodels.code.Exception>)newValue);
				return;
			case CodePackage.CODE__GLOBAL_VARIABLE:
