 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.PropertyAccessImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.PropertyAccessImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.PropertyAccessImpl#getNextAccess <em>Next Access</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.code.impl.PropertyAccessImpl#getDataProducer <em>Data Producer</em>}</li>
 * </ul>
 *
 * @generated
 */
