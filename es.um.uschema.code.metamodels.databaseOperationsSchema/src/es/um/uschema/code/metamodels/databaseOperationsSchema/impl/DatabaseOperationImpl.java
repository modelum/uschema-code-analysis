 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.databaseOperationsSchema.impl.DatabaseOperationImpl#getFollowingDatabaseOperation <em>Following Database Operation</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.databaseOperationsSchema.impl.DatabaseOperationImpl#getPrecedingDatabaseOperation <em>Preceding Database Operation</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.databaseOperationsSchema.impl.DatabaseOperationImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.databaseOperationsSchema.impl.DatabaseOperationImpl#getStatement <em>Statement</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.databaseOperationsSchema.impl.DatabaseOperationImpl#getTargetingParameter <em>Targeting Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
