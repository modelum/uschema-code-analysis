 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.databaseOperationsSchema.impl.ReferenceImpl#getTargetContainer <em>Target Container</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.databaseOperationsSchema.impl.ReferenceImpl#getTargetField <em>Target Field</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.databaseOperationsSchema.impl.ReferenceImpl#getReferenceType <em>Reference Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImpl extends TypeImpl implements Reference {
	 ...
	 * @ordered
	 */
	protected es.um.uschema.code.metamodels.databaseOperationsSchema.Container targetContainer;
	 ...
	 */
	@Override
	public es.um.uschema.code.metamodels.databaseOperationsSchema.Container getTargetContainer() {
		if (targetContainer != null && targetContainer.eIsProxy()) {
			InternalEObject oldTargetContainer = (InternalEObject)targetContainer;
			targetContainer = (es.um.uschema.code.metamodels.databaseOperationsSchema.Container)eResolveProxy(oldTargetContainer);
	 ...
	 * @generated
	 */
	public es.um.uschema.code.metamodels.databaseOperationsSchema.Container basicGetTargetContainer() {
		return targetContainer;
	}
	 ...
	 */
	@Override
	public void setTargetContainer(es.um.uschema.code.metamodels.databaseOperationsSchema.Container newTargetContainer) {
		es.um.uschema.code.metamodels.databaseOperationsSchema.Container oldTargetContainer = targetContainer;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case DatabaseOperationsSchemaPackage.REFERENCE__TARGET_CONTAINER:
				setTargetContainer((es.um.uschema.code.metamodels.databaseOperationsSchema.Container)newValue);
				return;
			case DatabaseOperationsSchemaPackage.REFERENCE__TARGET_FIELD:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case DatabaseOperationsSchemaPackage.REFERENCE__TARGET_CONTAINER:
				setTargetContainer((es.um.uschema.code.metamodels.databaseOperationsSchema.Container)null);
				return;
			case DatabaseOperationsSchemaPackage.REFERENCE__TARGET_FIELD:
