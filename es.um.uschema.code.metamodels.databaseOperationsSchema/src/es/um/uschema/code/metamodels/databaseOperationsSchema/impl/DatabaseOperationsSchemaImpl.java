 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.uschema.code.metamodels.databaseOperationsSchema.impl.DatabaseOperationsSchemaImpl#getDatabaseOperations <em>Database Operations</em>}</li>
 *   <li>{@link es.um.uschema.code.metamodels.databaseOperationsSchema.impl.DatabaseOperationsSchemaImpl#getContainers <em>Containers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DatabaseOperationsSchemaImpl extends MinimalEObjectImpl.Container implements DatabaseOperationsSchema {
	 ...
	 * @ordered
	 */
	protected EList<es.um.uschema.code.metamodels.databaseOperationsSchema.Container> containers;
	 ...
	 */
	@Override
	public EList<es.um.uschema.code.metamodels.databaseOperationsSchema.Container> getContainers() {
		if (containers == null) {
			containers = new EObjectContainmentEList<es.um.uschema.code.metamodels.databaseOperationsSchema.Container>(es.um.uschema.code.metamodels.databaseOperationsSchema.Container.class, this, DatabaseOperationsSchemaPackage.DATABASE_OPERATIONS_SCHEMA__CONTAINERS);
		}
		return containers;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DatabaseOperationsSchemaPackage.DATABASE_OPERATIONS_SCHEMA__CONTAINERS:
				getContainers().clear();
				getContainers().addAll((Collection<? extends es.um.uschema.code.metamodels.databaseOperationsSchema.Container>)newValue);
				return;
		}
