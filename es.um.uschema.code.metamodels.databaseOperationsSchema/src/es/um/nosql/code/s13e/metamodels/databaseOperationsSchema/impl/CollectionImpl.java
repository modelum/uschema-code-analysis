 ...
 * </p>
 * <ul>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.databaseOperationsSchema.impl.CollectionImpl#getCollectionType <em>Collection Type</em>}</li>
 *   <li>{@link es.um.nosql.code.s13e.metamodels.databaseOperationsSchema.impl.CollectionImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionImpl extends TypeImpl implements Collection
{
	...
	{
		return DatabaseOperationsSchemaPackage.Literals.COLLECTION;
	}
	...
	public void setCollectionType(String newCollectionType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatabaseOperationsSchemaPackage.COLLECTION__COLLECTION_TYPE, oldCollectionType, collectionType));
	}
	...
	{
		if (types == null) {
			types = new EObjectContainmentEList<Type>(Type.class, this, DatabaseOperationsSchemaPackage.COLLECTION__TYPES);
		}
		return types;
	}
	...
	{
		switch (featureID) {
			case DatabaseOperationsSchemaPackage.COLLECTION__TYPES:
	...
	{
		switch (featureID) {
			case DatabaseOperationsSchemaPackage.COLLECTION__COLLECTION_TYPE:
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID) {
			...
			case DatabaseOperationsSchemaPackage.COLLECTION__TYPES:
				getTypes().clear();
				getTypes().addAll((java.util.Collection<? extends Type>)newValue);
				return;
		}
